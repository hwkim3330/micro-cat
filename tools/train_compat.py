...
p=argparse.ArgumentParser();p.add_argument('--updates',type=int,default=10);p.add_argument('--steps',type=int,default=256);p.add_argument('--seed',type=int,default=42);p.add_argument('--name',default='micro_cat_14');args=p.parse_args()
import re
...
if args.name=='micro_cat_14':(R/'artifacts/compat_training.json').write_text(json.dumps(report,indent=2)+'\n')

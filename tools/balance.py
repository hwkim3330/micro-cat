...
m=mujoco.MjModel.from_xml_path(str(R/'models/micro_cat_14.xml'));d=mujoco.MjData(m);mujoco.mj_forward(m,d)
...
report=dict(scope='HOME pose, both feet flat; CAD-derived masses (PLA solid density + purchased catalogue masses); fasteners, cables and print infill not modelled.',
    ...
    bodies=per_body,model_sha256=hashlib.sha256((R/'models/micro_cat_14.xml').read_bytes()).hexdigest(),physical_verified=False)

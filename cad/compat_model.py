"""Micro Cat Rev 1 14-axis MuJoCo model, generated from the cat CAD.
...
def build():
    ...
    E.indent(r);E.ElementTree(r).write(R/'models/micro_cat_14.xml',encoding='unicode')
    # Standing height at HOME: the absolute trunk height that puts the lowest foot corner on the floor.
    m=mujoco.MjModel.from_xml_path(str(R/'models/micro_cat_14.xml'));d=mujoco.MjData(m)
    ...
    print(f'Built Rev 1 14-axis model, mass {total*1000:.0f} g, HOME trunk height {home_z*1000:.1f} mm')

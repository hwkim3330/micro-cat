"""Purchased smart-servo envelope and clevis helpers for the actuated Micro Cat. mm.
...
def horn_plate(P,h,d,width=ACROSS,length=None,thickness=PLATE,name=None):
    ...
    # The four M2 holes sit on a 12 mm circle. If the plate is narrower than the circle plus
    # material around the holes, the bolts run off the edge and the joint has nothing to bear
    # against. Refuse to build it rather than ship a plate that cannot hold its own servo.

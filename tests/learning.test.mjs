...
test('foreign, malformed or nonfinite policies cannot execute',()=>{
  const valid={schema:'micro-cat-policy-v1',environment:ENV,algorithm:'cem-log-pd',joint:'virtual_jaw',angleRangeDegrees:[0,20],weights:[1,2]};assert.deepEqual(validatePolicy(valid),[1,2]);
